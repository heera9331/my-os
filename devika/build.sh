...
gcc -m32 -c ./src/kernel/mouse.c -o ./obj/mouse.o -ffreestanding
...
ld -m elf_i386 -T ./src/link.ld -o ./boot/kernel.bin ./obj/loader.o ./obj/kernel.o ./obj/idt.o ./obj/keyboard.o ./obj/mouse.o ./obj/screen.o ./obj/string.o ./obj/system.o ./obj/util.o ./obj/shell.o ./obj/isr.o ./obj/stdio.o ./obj/stdlib.o
